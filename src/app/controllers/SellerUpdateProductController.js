...
class SellerUpdateProductController {
    ...
    productUpdateNoImge(req, res, next){
        let urlImage;
        if(req.body.SP_ten !== '' && req.body.SP_soluong === '' && req.body.SP_gia === ''  && req.body.SP_khuyenmai === '' && req.body.DM_id === '' && req.body.SP_trongluong === '' && req.body.SP_mota === ''){
            ...
            urlImage = `UPDATE sanpham SET SP_khuyenmai='${req.body.SP_khuyenmai}', SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia === '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === '' && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_khuyenmai='${req.body.SP_khuyenmai}', SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }
        else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia === '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            ...
            urlImage = `UPDATE sanpham SET SP_ten='${req.body.SP_ten}',SP_khuyenmai='${req.body.SP_khuyenmai}',SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong === '' && req.body.SP_gia === '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === ''  && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_ten='${req.body.SP_ten}',SP_khuyenmai='${req.body.SP_khuyenmai}', SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong === '' && req.body.SP_gia === '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== ''  && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            ...
            urlImage = `UPDATE sanpham SET SP_soluong='${req.body.SP_soluong}',SP_khuyenmai='${req.body.SP_khuyenmai}', DM_id='${req.body.DM_id}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong !== '' && req.body.SP_gia === '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === '' && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            urlImage = `UPDATE sanpham SET SP_soluong='${req.body.SP_soluong}',SP_khuyenmai='${req.body.SP_khuyenmai}', SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong !== '' && req.body.SP_gia === '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === '' && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_soluong='${req.body.SP_soluong}',SP_khuyenmai='${req.body.SP_khuyenmai}', SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong !== '' && req.body.SP_gia === '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            ...
            urlImage = `UPDATE sanpham SET SP_gia='${req.body.SP_gia}', SP_khuyenmai='${req.body.SP_khuyenmai}', SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === ''  && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_gia='${req.body.SP_gia}', SP_khuyenmai='${req.body.SP_khuyenmai}', SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== ''  && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            ...
            urlImage = `UPDATE sanpham SET SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}', SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia === '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== ''  && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_khuyenmai='${req.body.SP_khuyenmai}', DM_id='${req.body.DM_id}', SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia === '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === ''  && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_khuyenmai='${req.body.SP_khuyenmai}', SP_trongluong='${req.body.SP_trongluong}', SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia === '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== ''  && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            ...
            urlImage = `UPDATE sanpham SET SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}', SP_khuyenmai='${req.body.SP_khuyenmai}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia === '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            ...
            urlImage = `UPDATE sanpham SET SP_soluong='${req.body.SP_soluong}',SP_gia='${req.body.SP_gia}', SP_khuyenmai='${req.body.SP_khuyenmai}',SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === '' && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_soluong='${req.body.SP_soluong}',SP_gia='${req.body.SP_gia}', SP_khuyenmai='${req.body.SP_khuyenmai}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }
            ...
            urlImage = `UPDATE sanpham SET SP_soluong='${req.body.SP_soluong}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong !== '' && req.body.SP_gia === '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_soluong='${req.body.SP_soluong}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }
        
        else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            urlImage = `UPDATE sanpham SET SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            ...
            urlImage = `UPDATE sanpham SET SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong === '' && req.body.SP_mota === ''){
            ...
            urlImage = `UPDATE sanpham SET SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}', SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === '' && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}', SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            ...
            urlImage = `UPDATE sanpham SET SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia === '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong === '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            ...
            urlImage = `UPDATE sanpham SET SP_soluong='${req.body.SP_soluong}',SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_soluong='${req.body.SP_soluong}',SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            ...
            urlImage = `UPDATE sanpham SET SP_soluong='${req.body.SP_soluong}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            urlImage = `UPDATE sanpham SET SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}',SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}',SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            ...
            urlImage = `UPDATE sanpham SET SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong === '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_ten='${req.body.SP_ten}',SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_soluong='${req.body.SP_soluong}',SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}',SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }
    ...
    productUpdateImge(req, res, next){
        ...
        if(req.body.SP_ten !== '' && req.body.SP_soluong === '' && req.body.SP_gia === ''  && req.body.SP_khuyenmai === '' && req.body.DM_id === '' && req.body.SP_trongluong === '' && req.body.SP_mota === ''){
            ...
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_khuyenmai='${req.body.SP_khuyenmai}', SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia === '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === '' && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_khuyenmai='${req.body.SP_khuyenmai}', SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia === '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            ...
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_ten='${req.body.SP_ten}',SP_khuyenmai='${req.body.SP_khuyenmai}',SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong === '' && req.body.SP_gia === '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === ''  && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_ten='${req.body.SP_ten}',SP_khuyenmai='${req.body.SP_khuyenmai}', SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong === '' && req.body.SP_gia === '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== ''  && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            ...
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_soluong='${req.body.SP_soluong}',SP_khuyenmai='${req.body.SP_khuyenmai}', DM_id='${req.body.DM_id}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong !== '' && req.body.SP_gia === '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === '' && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_soluong='${req.body.SP_soluong}',SP_khuyenmai='${req.body.SP_khuyenmai}', SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong !== '' && req.body.SP_gia === '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === '' && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_soluong='${req.body.SP_soluong}',SP_khuyenmai='${req.body.SP_khuyenmai}', SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong !== '' && req.body.SP_gia === '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            ...
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_gia='${req.body.SP_gia}', SP_khuyenmai='${req.body.SP_khuyenmai}', SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === ''  && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_gia='${req.body.SP_gia}', SP_khuyenmai='${req.body.SP_khuyenmai}', SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== ''  && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            ...
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}', SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia === '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== ''  && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            ...
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_trongluong='${req.body.SP_trongluong}', SP_trongluong='${req.body.SP_trongluong}', SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }
        else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === ''  && req.body.SP_trongluong === '' && req.body.SP_mota === ''){
            ...
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}', SP_khuyenmai='${req.body.SP_khuyenmai}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia === '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            ...
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_soluong='${req.body.SP_soluong}',SP_gia='${req.body.SP_gia}', SP_khuyenmai='${req.body.SP_khuyenmai}',SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === '' && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_soluong='${req.body.SP_soluong}',SP_gia='${req.body.SP_gia}', SP_khuyenmai='${req.body.SP_khuyenmai}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            ...
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_soluong='${req.body.SP_soluong}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong !== '' && req.body.SP_gia === '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_soluong='${req.body.SP_soluong}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_gia='${req.body.SP_gia}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia === '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong === '' && req.body.SP_mota === ''){
            ...
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}', SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === '' && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}', SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}', SP_gia='${req.body.SP_gia}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== '' && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}', SP_gia='${req.body.SP_gia}',DM_id='${req.body.DM_id}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia === '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia === '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong === '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong === '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            ...
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_soluong='${req.body.SP_soluong}',SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_soluong='${req.body.SP_soluong}',SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_soluong='${req.body.SP_soluong}',SP_gia='${req.body.SP_gia}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong !== '' && req.body.SP_gia === '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_soluong='${req.body.SP_soluong}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong === '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota === ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}',SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id === '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}',SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}',SP_gia='${req.body.SP_gia}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai === '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}',SP_gia='${req.body.SP_gia}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia === '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong === '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_ten='${req.body.SP_ten}',SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten === '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_soluong='${req.body.SP_soluong}',SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten !== '' && req.body.SP_soluong !== '' && req.body.SP_gia !== '' && req.body.SP_khuyenmai !== '' && req.body.DM_id !== '' && req.body.SP_trongluong !== '' && req.body.SP_mota !== ''){
            urlImage = `UPDATE sanpham SET SP_image='${req.body.SP_image}', SP_ten='${req.body.SP_ten}',SP_soluong='${req.body.SP_soluong}',SP_gia='${req.body.SP_gia}',SP_khuyenmai='${req.body.SP_khuyenmai}',DM_id='${req.body.DM_id}',SP_trongluong='${req.body.SP_trongluong}',SP_mota='${req.body.SP_mota}' WHERE NB_id = '${req.body.NB_id}' AND SP_id = '${req.body.SP_id}'`;
        }else if(req.body.SP_ten == '' && req.body.SP_soluong == '' && req.body.SP_gia == '' && req.body.SP_khuyenmai == '' && req.body.DM_id == '' && req.body.SP_trongluong == '' && req.body.SP_mota == ''){
